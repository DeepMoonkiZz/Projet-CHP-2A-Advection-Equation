...
vector<double> BiCg (vector<double> U, struct Parameters data)
{
    ...
    vector<double> r(data.Nx*data.Ny, 0.0), r1(data.Nx*data.Ny, 0.0); // Etape 1 et 2
    vector<double> p(data.Nx*data.Ny, 0.0); // Etape 4
    vector<double> v(data.Nx*data.Ny, 0.0); // Etape 5.1
    vector<double> h(data.Nx*data.Ny, 0.0); // Etape 5.3
    vector<double> s(data.Nx*data.Ny, 1.0); // Etape 5.4
    vector<double> t(data.Nx*data.Ny, 0.0); // Etape 5.6
